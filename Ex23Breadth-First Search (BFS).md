...
5.Repeat e times.
6.Read the source node.
7.Initialize a boolean array of size n, all set to false.
8.Create an empty queue.
9.Mark src as visited and enqueue it.
10.Continue until all reachable nodes are processed.
11.Stop the program.
...
<img width="711" height="450" alt="image" src="https://github.com/user-attachments/assets/af14833b-1625-423d-97e1-d428bf0b1ee9" />
